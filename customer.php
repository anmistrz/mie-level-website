...
$cst = query("SELECT * FROM customer");
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <table border="1" id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <?php $i=1; ?>
                            <?php foreach ($cst as $row): ?>
                                <tr align="center">
                                    <td><?= $i; ?></td>
                                    <td><img src="photo/<?= $row["foto_cst"];?>" width="80"></td>
                                    <td><?= $row["id_cst"]; ?></td>
                                    <td><?= $row["nama_cst"]; ?></td>
                                    <td><?= $row["alamat_cst"]; ?></td>
                                    <td><?= $row["nohp_cst"]; ?></td>
                                    <td><?= $row["username"]; ?></td>
                                    <td><?= $row["password"]; ?></td>
                                    <td>
                                        <a href="delete_cst_adm.php?id=<?=$row['id_cst']?>" class=" btn btn-danger"> 
