...
$menu = query("SELECT bayar_berhasil.no_bayar, bayar_berhasil.no_transaksi, bayar_berhasil.id_cst, customer.nama_cst, bayar_berhasil.total_byr, 
        bayar_berhasil.jenis_byr, bayar_berhasil.tgl_byr, bayar_berhasil.status FROM bayar_berhasil, customer WHERE bayar_berhasil.id_cst = customer.id_cst");
        ...
        <div class="content" id="content">
                ...
                <div class="card">
		            <div class="card-header">
			            <h3>Laporan Pembayaran Berhasil</h3>
		            </div>
                           ...
                           <!-- <?php $i=1; ?>
                            <?php foreach ($menu as $row): ?> -->
                                <tr>
                                    ...
                                    <td>
                                        <a href="report_berhasil_adm.php?id=<?=$row['no_transaksi']?>" class="link btn btn-info"> <span data-feather="shopping-cart"></span> Detail Order</a>
                                    </td>
                                </tr>
                            <!-- <?php $i++;?>   
                            <?php endforeach ?> --> -->
