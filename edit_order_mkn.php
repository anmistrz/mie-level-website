                        ...
                        <div class="row align-items-center justify-content-center" style="kotak_input_room">
                            <form method="POST"  class="kotak_input_room" enctype="multipart/form-data">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-10">
                                    <input type="hidden" class="form-control" name='lvl_old' value="<?=$order['level'];?>" id="lvl_old" readonly>
                                        <select name="level" class="form-control" aria-label=".form-select-lg example" required>

                                            <option disabled selected><?=$order['level'];?></option>
