                        ...
                        <div class="row align-items-center justify-content-center" style="kotak_input_room">
                            <form method="POST"  class="kotak_input_room" enctype="multipart/form-data">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name='nama_menu' id="nama_menu" required value="<?=$menu['nama_menu'];?>">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <label for="username" class="col-sm-2 col-form-label">Jenis Menu</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name='jenis_menu' id="jenis_menu" required value="<?=$menu['jenis_menu'];?>">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <label for="password" class="col-sm-2 col-form-label">Harga</label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name='harga' id="harga" required value="<?=$menu['harga'];?>">
                                    </div>
                                </div>
                                <div class="row mb-4">
                                    <label  for="alamat_adm" class="col-sm-2 col-form-label">Detail</label>
                                        <div class="col-sm-10">
                                            <textarea class="form-control" style="resize: none;" name="detail" id="detail" rows="3"><?=$menu['detail'];?></textarea>
                                        </div>                    
                                </div>
                                <div class="row mb-4">
                                    <label for="gambar_adm" class="col-sm-2 col-form-label">Foto</label>
                                        <div class="col-sm-10">
                                            <img src="photo/<?php echo $menu['foto_menu']; ?>" width="150px" height="150px" /></br>
