                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 mt-3">
                                ...
                                <form action="detail_menu.php" method="POST" class="col-12 mt-4 row justify-content-center align-items-center">
                                    ...
                                    <div class=" mb-4 mt-4 row justify-content-center " style="width: 800px;">
                                        <div class="col-sm-10 mt-3">
                                            ...
                                            <input type="hidden" class="form-control" name='id_menu' id="id_menu" value="<?= $menu['id_menu']?>" readonly>
                                        ...
                                        <!-- <div class="col-sm-10 mt-3">
                                            ...
                                            <select name="jml_order" class="form-control" aria-label=".form-select-lg example" required>
